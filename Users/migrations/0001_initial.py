    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Yönetici'), ('AGENT', 'Acente'), ('SUBAGENT', 'Alt Acente'), ('USER', 'Kullanıcı')], max_length=10)),
                ('phone', models.CharField(max_length=15)),
                ('gender', models.CharField(max_length=10)),
                ('marital_status', models.CharField(max_length=10)),
                ('education_status', models.CharField(max_length=30)),
